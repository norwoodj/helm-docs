...
| chart.dependenciesHeader       | The heading for the chart dependencies section                                                                                                                                                                                                                                                                                                                                                                                        |
| chart.dependenciesTable        | A table of the chart's required sub-charts                                                                                                                                                                                                                                                                                                                                                                                            |
| chart.dependenciesSection      | A section headed by the dependenciesHeader from above containing the kubeVersionLine and/or the dependenciesTable from above or "" if there are no dependencies                                                                                                                                                                                                                                                                       |
