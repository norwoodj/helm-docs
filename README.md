...
| chart.valueDescriptionColumnRender | This is a hook template if you want to redefine how helm-docs render the descripition values in `chart.valuesTableHtml` mode. |
